namespace MyParser.Provider.Xiaohongshu.Models;

public sealed record XiaohongshuParseResult
{
...
public sealed record XiaohongshuImageInfo
{
...
public sealed record XiaohongshuVideoFormat
{
    public required string Url { get; init; }
...
public sealed record XiaohongshuComment
{
...
public sealed record XiaohongshuUser
{
    public string? Id { get; init; }
...
public sealed record XiaohongshuLoginStatus(bool IsLogin, string? UserName, string? UserId, string Message, bool NeedVerify = false);

public sealed record XiaohongshuQrLoginSession(string QrId, string Code, string Url, string Cookie, DateTimeOffset CreatedAt);

public sealed record XiaohongshuQrPollResult(int CodeStatus, string Message, bool IsLogin, bool NeedVerify, string Cookie, string? UserName = null);

public class XiaohongshuParseException(string message) : Exception(message);

public sealed class XiaohongshuLoginRequiredException(string message) : XiaohongshuParseException(message);

public sealed class XiaohongshuSignRequiredException(string message) : XiaohongshuParseException(message);
