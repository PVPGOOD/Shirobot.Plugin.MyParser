...
internal sealed record BilibiliParseResult
{
...
internal sealed record BilibiliLoginStatus(bool IsLogin, string? UserName, long Mid, int VipStatus, string Message);

internal sealed record BilibiliQrLoginSession(string QrcodeKey, string Url, DateTimeOffset CreatedAt);

internal sealed record BilibiliQrPollResult(int Code, string Message, bool IsLogin, string? UserName);

internal class BilibiliParseException(string message) : Exception(message);

internal sealed class BilibiliLoginRequiredException(string message) : BilibiliParseException(message);
