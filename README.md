...
当前支持抖音、Bilibili、小红书内容解析，包括视频、图集、图文、专栏、封面卡片渲染、长文档图片渲染、评论卡片和消息转发流程。
...
- 支持手动命令触发：`#parse <链接>`。
- 支持抖音视频、图集、LivePhoto 解析与转发。
- 支持 Bilibili 视频、专栏、图文 / opus 解析与转发。
- 支持小红书视频、图文、前 10 条评论获取与图文问答卡片渲染。
